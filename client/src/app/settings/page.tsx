                            ...
                            <td className="py-2 px-4">
                                {setting.type === "toggle" ? (
                                    <label className="inline-flex relative items-center cursor-pointer">
                                        ...
                                        <div className="w-11 h-6 bg-gray-200 rounded-full peer peer-focus:ring-4 peer-focus:ring-blue-400 dark:peer-focus:ring-blue-800 
                                    ...
                                    <input type="text" className="w- px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" 
